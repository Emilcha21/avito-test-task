...
func (s *Service) PrFromModelToDto(req *models.PullRequest) *dto.PullRequestResp {
...
func (s *Service) PrFromDtoToModel(req *dto.CreatePullRequestReq) *models.PullRequest {
